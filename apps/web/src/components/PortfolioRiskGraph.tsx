        ...
        <div className="h-full bg-black/95 backdrop-blur-xl rounded-2xl border border-white/10 overflow-hidden flex">
          ...
          <div className="w-72 border-l border-white/10 p-4 bg-white/[0.02] flex flex-col">
            ...
            <div className="space-y-2">
              <button className="w-full px-4 py-2 bg-cyan-500/20 text-cyan-400 rounded-lg border border-cyan-500/30 hover:bg-cyan-500/30 transition-colors text-sm flex items-center justify-center gap-2">
