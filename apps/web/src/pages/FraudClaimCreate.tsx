    ...
    <div className="h-full overflow-auto p-8">
      ...
      <form onSubmit={handleSubmit} className="glass rounded-2xl p-6 border border-white/5 max-w-xl">
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-white/80 mb-1">Asset *</label>
            <select
              required
              value={form.asset_id}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-white/80 mb-1">Claim type</label>
              <select
            ...
            <div>
              <label className="block text-sm font-medium text-white/80 mb-1">Damage type</label>
              <select
          ...
          <div>
            <label className="block text-sm font-medium text-white/80 mb-1">Claimed loss amount (€) *</label>
            <input
              type="number"
              min="0"
              step="100"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-white/80 mb-1">Claimant name</label>
              <input
                type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-white/80 mb-1">Damage location</label>
            <input
              type="text"
