...
export default function RegulatorMode() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-900">
      ...
      <header className="bg-white border-b border-zinc-200 px-8 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-display font-semibold text-zinc-900 tracking-tight">
          ...
          <div className="flex items-center gap-6">
            ...
            {/* Export */}
            <button className="flex items-center gap-2 px-4 py-2 bg-zinc-900 text-zinc-100 text-sm font-medium rounded-md hover:bg-zinc-800 transition-colors">
        ...
        {/* Metadata bar */}
        <div className="flex items-center gap-8 mt-4 text-sm text-zinc-600">
          <div>
            <span className="font-mono text-zinc-400">Institution:</span>{' '}
            <span className="font-medium">Global Risk Platform</span>
          </div>
          <div>
            <span className="font-mono text-zinc-400">Reference Date:</span>{' '}
            <span className="font-medium">{today}</span>
          </div>
          <div>
            <span className="font-mono text-zinc-400">Methodology:</span>{' '}
            <span className="font-medium">v3.2.1</span>
          </div>
          <div>
            <span className="font-mono text-zinc-400">Scope:</span>{' '}
      ...
      {/* Tab Navigation */}
      <nav className="bg-white border-b border-zinc-200 px-8">
      ...
      <main className="p-8 max-w-7xl mx-auto">
        ...
        {activeTab === 'coverage' && (
          ...
          >
            <div className="bg-white rounded-md border border-zinc-200 p-6">
              <h2 className="text-lg font-display font-semibold text-zinc-900 mb-4">Coverage Summary</h2>
              <div className="grid grid-cols-4 gap-6">
                <div className="p-4 bg-zinc-50 rounded-md">
                  <div className="font-mono text-[10px] text-zinc-500 uppercase tracking-widest">Total AUM</div>
                  <div className="text-2xl font-semibold text-zinc-900">€{coverageData.totalAUM}M</div>
                </div>
                <div className="p-4 bg-zinc-50 rounded-md">
                  <div className="font-mono text-[10px] text-zinc-500 uppercase tracking-widest">Covered AUM</div>
                  <div className="text-2xl font-semibold text-emerald-700">€{coverageData.coveredAUM}M</div>
                </div>
                <div className="p-4 bg-zinc-50 rounded-md">
                  <div className="font-mono text-[10px] text-zinc-500 uppercase tracking-widest">Coverage Rate</div>
                  <div className="text-2xl font-semibold text-zinc-900">{coverageData.coveragePercent}%</div>
                </div>
                <div className="p-4 bg-zinc-50 rounded-md">
                  <div className="font-mono text-[10px] text-zinc-500 uppercase tracking-widest">Exclusions</div>
            ...
            <div className="bg-white rounded-md border border-zinc-200 p-6">
              <h2 className="text-lg font-display font-semibold text-zinc-900 mb-4">Coverage by Asset Class</h2>
              <table className="w-full">
                <thead>
                  <tr className="border-b border-zinc-200">
                    <th className="text-left text-sm font-medium text-zinc-500 pb-3">Asset Class</th>
                    <th className="text-right text-sm font-medium text-zinc-500 pb-3">AUM (€M)</th>
                    <th className="text-right text-sm font-medium text-zinc-500 pb-3">Coverage</th>
                    <th className="text-left text-sm font-medium text-zinc-500 pb-3 pl-6">Status</th>
                  </tr>
                </thead>
                <tbody>
                  {coverageData.assetClasses.map(ac => (
                    <tr key={ac.name} className="border-b border-zinc-100">
                      ...
                      <td className="py-3 text-sm text-zinc-900 text-right font-mono">€{ac.aum}M</td>
            ...
            <div className="bg-white rounded-md border border-zinc-200 p-6">
              <h2 className="text-lg font-display font-semibold text-zinc-900 mb-4">Exclusion Justification</h2>
              <table className="w-full">
                <thead>
                  <tr className="border-b border-zinc-200">
                    <th className="text-left text-sm font-medium text-zinc-500 pb-3">Category</th>
                    <th className="text-right text-sm font-medium text-zinc-500 pb-3">AUM (€M)</th>
                    <th className="text-left text-sm font-medium text-zinc-500 pb-3 pl-6">Justification</th>
                  </tr>
                </thead>
                <tbody>
                  {coverageData.exclusions.map((exc, i) => (
                    <tr key={i} className="border-b border-zinc-100">
                      ...
                      <td className="py-3 text-sm text-zinc-900 text-right font-mono">€{exc.aum}M</td>
                      <td className="py-3 text-sm text-zinc-600 pl-6">{exc.reason}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        {activeTab === 'scenarios' && (
          ...
          >
            <div className="bg-white rounded-md border border-zinc-200 p-6">
              <h2 className="text-lg font-display font-semibold text-zinc-900 mb-2">NGFS Scenario Framework</h2>
              ...
              <div className="space-y-4">
                {scenarioData.map(scenario => (
                  <div key={scenario.id} className="border border-zinc-200 rounded-md p-4">
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <h3 className="font-semibold text-zinc-900">{scenario.name}</h3>
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-4">
                      <div>
                        <div className="font-mono text-[10px] text-zinc-500 uppercase tracking-widest mb-2">Time Horizons</div>
                        <div className="flex gap-2">
                          {scenario.horizons.map(h => (
                            <span key={h} className="px-2 py-1 text-xs font-mono bg-zinc-100 rounded">{h}</span>
                          ))}
                        </div>
                      </div>
                      <div>
                        <div className="font-mono text-[10px] text-zinc-500 uppercase tracking-widest mb-2">Key Variables</div>
                        <div className="flex flex-wrap gap-2">
                          {scenario.variables.map((v, i) => (
                            <span key={i} className="px-2 py-1 text-xs bg-zinc-100 rounded">{v}</span>
                          ))}
                        </div>
                      </div>
                    </div>
        ...
        {activeTab === 'loss-chain' && (
          ...
          >
            <div className="bg-white rounded-md border border-zinc-200 p-6">
              <h2 className="text-lg font-display font-semibold text-zinc-900 mb-2">Loss Calculation Methodology</h2>
              <p className="text-sm text-zinc-500 mb-6">
              ...
              <div className="space-y-4">
                {lossChainSteps.map((step, i) => (
                  <div key={step.step} className="relative">
                    {i > 0 && (
                      <div className="absolute left-6 -top-4 w-px h-4 bg-zinc-300" />
                    )}
                    <div className="flex gap-4">
                      <div className="w-12 h-12 rounded-full bg-zinc-900 text-zinc-100 flex items-center justify-center font-bold shrink-0">
                        {step.step}
                      </div>
                      <div className="flex-1 border border-zinc-200 rounded-md p-4">
                        <div className="flex items-start justify-between mb-2">
                          <h3 className="font-semibold text-zinc-900">{step.name}</h3>
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          <div>
                            <div className="font-mono text-[10px] text-zinc-500 uppercase tracking-widest mb-1">Formula</div>
                            <code className="text-xs bg-zinc-100 px-2 py-1 rounded font-mono text-zinc-700">
                              {step.formula}
                            </code>
                          </div>
                          <div>
                            <div className="font-mono text-[10px] text-zinc-500 uppercase tracking-widest mb-1">Data Source</div>
          ...
          >
            <div className="bg-white rounded-md border border-zinc-200 p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h2 className="text-lg font-display font-semibold text-zinc-900">Stress Test Results</h2>
                  <p className="text-sm text-zinc-500">Scenario-based loss projections</p>
                </div>
                <div className="flex gap-2">
                  <button className="px-3 py-1.5 text-sm border border-zinc-300 rounded hover:bg-zinc-50 transition-colors">
                    Export CSV
                  </button>
                  <button className="px-3 py-1.5 text-sm border border-zinc-300 rounded hover:bg-zinc-50 transition-colors">
                    Export PDF
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-zinc-200">
                    <th className="text-left text-sm font-medium text-zinc-500 pb-3">Scenario</th>
                    <th className="text-right text-sm font-medium text-zinc-500 pb-3">Loss (€M)</th>
                    <th className="text-right text-sm font-medium text-zinc-500 pb-3">% NAV</th>
                    <th className="text-left text-sm font-medium text-zinc-500 pb-3 pl-6">Confidence</th>
                  </tr>
                </thead>
                <tbody>
                  {stressResults.map((result, i) => (
                    <tr key={i} className="border-b border-zinc-100">
                      <td className="py-3 text-sm text-zinc-900 font-medium">{result.scenario}</td>
                      <td className="py-3 text-sm text-right font-mono">
                        <span className={result.loss > 500 ? 'text-red-600' : result.loss > 200 ? 'text-amber-600' : 'text-zinc-900'}>
                          €{result.loss}M
                        </span>
                      </td>
                      <td className="py-3 text-sm text-right font-mono">
                        <span className={result.pctNAV > 20 ? 'text-red-600' : result.pctNAV > 10 ? 'text-amber-600' : 'text-zinc-900'}>
        ...
        {activeTab === 'governance' && (
          ...
          >
            {/* Model Governance */}
            <div className="bg-white rounded-md border border-zinc-200 p-6">
              <h2 className="text-lg font-display font-semibold text-zinc-900 mb-4">Model Governance</h2>
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div className="flex justify-between py-2 border-b border-zinc-100">
                    <span className="font-mono text-sm text-zinc-500">Model Owner</span>
                    <span className="text-sm font-medium text-zinc-900">{governanceData.modelOwner}</span>
                  </div>
                  <div className="flex justify-between py-2 border-b border-zinc-100">
                    <span className="font-mono text-sm text-zinc-500">Validation Owner</span>
                    <span className="text-sm font-medium text-zinc-900">{governanceData.validationOwner}</span>
                  </div>
                  <div className="flex justify-between py-2 border-b border-zinc-100">
                    <span className="font-mono text-sm text-zinc-500">Last Validation</span>
                    <span className="text-sm font-medium text-zinc-900">{governanceData.lastValidation}</span>
                  </div>
                  <div className="flex justify-between py-2 border-b border-zinc-100">
                    <span className="font-mono text-sm text-zinc-500">Next Validation</span>
                    <span className="text-sm font-medium text-zinc-900">{governanceData.nextValidation}</span>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="flex justify-between py-2 border-b border-zinc-100">
                    <span className="font-mono text-sm text-zinc-500">Last Backtest</span>
                    <span className="text-sm font-medium text-zinc-900">{governanceData.backtestDate}</span>
                  </div>
                  <div className="flex justify-between py-2 border-b border-zinc-100">
                    <span className="font-mono text-sm text-zinc-500">Backtest Result</span>
                  ...
                  <div className="flex justify-between py-2 border-b border-zinc-100">
                    <span className="font-mono text-sm text-zinc-500">Update Frequency</span>
                    <span className="text-sm font-medium text-zinc-900">Quarterly</span>
                  </div>
                  <div className="flex justify-between py-2 border-b border-zinc-100">
                    <span className="font-mono text-sm text-zinc-500">Audit Status</span>
            ...
            <div className="bg-white rounded-md border border-zinc-200 p-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-display font-semibold text-zinc-900">Override Log</h2>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-zinc-200">
                    <th className="text-left text-sm font-medium text-zinc-500 pb-3">Date</th>
                    <th className="text-left text-sm font-medium text-zinc-500 pb-3">Reason</th>
                    <th className="text-left text-sm font-medium text-zinc-500 pb-3">Approver</th>
                  </tr>
                </thead>
                <tbody>
                  {governanceData.overrideLog.map((entry, i) => (
                    <tr key={i} className="border-b border-zinc-100">
                      <td className="py-3 text-sm text-zinc-600 font-mono">{entry.date}</td>
