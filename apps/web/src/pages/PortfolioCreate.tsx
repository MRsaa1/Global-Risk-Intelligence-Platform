      ...
      <form onSubmit={handleSubmit} className="glass rounded-2xl p-6 border border-white/5 max-w-xl">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-white/80 mb-1">Base currency</label>
              <select
          ...
          <div>
            <label className="block text-sm font-medium text-white/80 mb-1">Manager name</label>
            <input
              type="text"
