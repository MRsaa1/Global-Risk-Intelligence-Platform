      ...
      <form onSubmit={handleSubmit} className="glass rounded-md p-6 border border-zinc-800 max-w-xl">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-zinc-200 mb-1">Status</label>
              <select
                value={form.status}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-zinc-200 mb-1">Total CAPEX (planned)</label>
              <input
                type="number"
                min="0"
                step="1000"
            ...
            <div>
              <label className="block text-sm font-medium text-zinc-200 mb-1">Annual revenue (projected)</label>
              <input
                type="number"
                min="0"
                step="1000"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-zinc-200 mb-1">Country</label>
              <input
                type="text"
